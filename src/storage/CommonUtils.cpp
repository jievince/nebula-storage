...
ErrorCode CommonUtils::to(const Status& status) {
    switch (status.code()) {
        case Status::kOk:
...
ErrorCode CommonUtils::to(kvstore::ResultCode rc) {
    switch (rc) {
        ...
        case kvstore::ResultCode::ERR_KEY_NOT_FOUND:
            return ErrorCode::E_KEY_NOT_FOUND;
        ...
        case kvstore::ResultCode::ERR_INVALID_DATA:
            return ErrorCode::E_INVALID_DATA;
        ...
        case kvstore::ResultCode::ERR_DATA_CONFLICT_ERROR:
            return ErrorCode::E_DATA_CONFLICT_ERROR;
        default:
...
kvstore::ResultCode CommonUtils::to(ErrorCode code) {
    switch (code) {
        case ErrorCode::SUCCEEDED:
            return kvstore::ResultCode::SUCCEEDED;
        case ErrorCode::E_LEADER_CHANGED:
